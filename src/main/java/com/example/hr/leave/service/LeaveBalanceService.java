...
public class LeaveBalanceService {
    ...
    private static final Map<LeaveType, Integer> ANNUAL_ENTITLEMENTS = Map.of(
            ...
            LeaveType.COMPASSIONATE, 3,  // Tang/Hiếu: 3 ngày
            LeaveType.STUDY, 5           // Học tập: 5 ngày
    );
    ...
    public LeaveBalanceService(LeaveRequestRepository leaveRequestRepository, com.example.hr.user.repository.UserRepository userRepository) {
