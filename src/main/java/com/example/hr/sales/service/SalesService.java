...
public class SalesService {
    ...
    public boolean canManageProduct(SalesProduct product, User user) {
        if (product == null || user == null || user.getRole() == null) {
            return false;
        }
        return user.getRole() == com.example.hr.enums.Role.ADMIN
                || user.getRole() == com.example.hr.enums.Role.MANAGER
    ...
    public SalesProduct updateProduct(Integer productId, SalesProduct updated, User user) {
        ...
        if (!canManageProduct(product, user)) {
            throw new IllegalArgumentException("Ban khong co quyen sua san pham nay");
        }
        ...
        if (user.getRole() == com.example.hr.enums.Role.USER || user.getRole() == com.example.hr.enums.Role.HIRING) {
            product.setApprovalStatus("PENDING");
    ...
    public void deactivateProduct(Integer productId, User user) {
        SalesProduct product = getProduct(productId);
        if (!canManageProduct(product, user)) {
            throw new IllegalArgumentException("Ban khong co quyen xoa san pham nay");
        }
