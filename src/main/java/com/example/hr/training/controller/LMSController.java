...
import com.example.hr.training.entity.*;
import com.example.hr.service.AuthUserHelper;
import com.example.hr.service.CloudinaryService;
import com.example.hr.training.service.CourseManagementService;
...
public class LMSController {
    ...
    public String enrollCourse(@PathVariable Integer courseId, 
        ...
        try {
            ...
            ra.addFlashAttribute("success", "ÄÄƒng kÃ½ khÃ³a há»c thÃ nh cÃ´ng!");
        } catch (Exception e) {
    ...
    public String updateCourseProgress(@PathVariable Integer enrollmentId,
        ...
        if (enrollment.getUser() == null || !enrollment.getUser().getId().equals(user.getId())) {
            ra.addFlashAttribute("error", "Báº¡n khÃ´ng cÃ³ quyá»n cáº­p nháº­t tiáº¿n Ä‘á»™ khÃ³a há»c nÃ y.");
        ...
        ra.addFlashAttribute("success", safeProgress >= 100 ? "ÄÃ£ hoÃ n thÃ nh khÃ³a há»c." : "ÄÃ£ cáº­p nháº­t tiáº¿n Ä‘á»™ há»c.");
    ...
    public String saveCourse(@ModelAttribute Course course,
        ...
        try {
            ...
            ra.addFlashAttribute("success", "Táº¡o khÃ³a há»c thÃ nh cÃ´ng!");
        } catch (Exception e) {
            ra.addFlashAttribute("error", e.getMessage());
        }
